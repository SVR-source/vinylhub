...
const Products = () => {
  ...
  const [q, setQ] = useState(""); const [fBranch, setFBranch] = useState("all"); const [detail, setDetail] = useState(null); const [edit, setEdit] = useState(null);
